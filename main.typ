...
El propósito de la primera fase es identificar los puntos de dolor que cuenta Nixlang, siendo la base para construir una solución los reduzca, a través de un estudio cualitativo exploratorio.
...
- *Tutoriales de Nixlang y eDSL*: Presentación del dominio del problema (gestión y
  ...
  representativos.
- *Cuestionarios de comprensión cognitiva*: Instrumento estructurado con
...
- *DEXI (Índice de Experiencia de Desarrollo)*: Instrumento para medir la experiencia de
